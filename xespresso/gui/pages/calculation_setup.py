            ...
            try:
                ...
                if codes and codes.has_any_codes():
                    ...
                    if codes.versions and len(available_versions) > 1:
                        ...
                        # Version selector
                        default_idx = 0
                        if st.session_state.get('calc_selected_version') and st.session_state.calc_selected_version in available_versions:
                            default_idx = available_versions.index(st.session_state.calc_selected_version)
