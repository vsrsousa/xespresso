...
def test_remote_calculation():
    ...
    input_data = {
        ...
        'outdir': './tmp',
        'prefix': 'si',
        'pseudo_dir': '/home/vinicius/scratch/vinicius/pseudos/',
        'tprnfor': True,
        'tstress': True,
        'disk_io': 'low',
    }
...
#        'Si': 'Si.pbe-n-rrkjus_psl.1.0.0.UPF',
    ...
    cluster_config = {
        "host": "152.92.133.79",  # Ajuste para seu host
        "user": "vinicius",             # Seu usuário no cluster
        "port": 222,                        # Porta SSH
#        "password": "AcimadeTudoRN@1981",
        "remote_base": "/home/{user}/scratch/vinicius/xespresso"  # Diretório remoto
    }
